...
> **Portability:** Requires a Consensus MCP connection, Node.js with `docx` package, and file reading capability for the syllabus. 任何具备上述能力的宿主均可运行（Claude Code / Claude.ai 为示例宿主）。
