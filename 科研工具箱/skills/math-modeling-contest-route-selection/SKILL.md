...
- **脚本路径**：本技能 scripts/score_topics.py（相对工具箱根 `科研工具箱/skills/math-modeling-contest-route-selection/scripts/score_topics.py`），Python 3 标准库实现，`python score_topics.py <input.json>` 直接可跑，零第三方依赖。
