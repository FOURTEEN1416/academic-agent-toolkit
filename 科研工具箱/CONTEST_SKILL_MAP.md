...
| 5 图表 | scipilot-figure-skill, agent-figure-gallery, academic-figure-skill, plot-from-data, plot-from-image, scientific-visualization, paper-figure-html, eco-community-plots | 选图三轴顾问/图库选参考/CNS 级精修/风格模板/复现成图/HTML 高密度图表/群落生态多元统计图（PCoA/RDA/Mantel/Procrustes，无 License 本地隔离） |
