...
- License: **MIT**
- Local use: `tools/pubfig/`（vendored，同 codesucker-core 惯例入 git）（Matplotlib-native 出版级 Python 库：paper-ready defaults/统一图族 API/期刊感知导出 save_figure+batch_export/agent-first JSON CLI render+validate-spec+list-kinds/panel-first Figma 多面板拼装）
