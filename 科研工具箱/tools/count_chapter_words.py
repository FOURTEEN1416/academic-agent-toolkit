# -*- coding: utf-8 -*-
"""Auto-generated wrapper for count_chapter_words.pyc (Python 3.11 pyc).
...
_pyc_path = _os.path.join(_os.path.dirname(_os.path.abspath(__file__)), "count_chapter_words.pyc")
...
_USAGE = 'Usage: python count_chapter_words.py <markdown-file>'
