...
def classify_path(relative_path: Path) -> tuple[str, str, str, str]:
    ...
    if normalized.startswith("科研工具箱/engine/") or normalized.startswith(
        "科研工具箱/tests/"
    ) or normalized.endswith("科研工具箱/AGENTS.md"):
        return "candidate_public_core", "runtime_core", "project_authored_unverified", "blocked"
    if normalized.startswith("科研工具箱/skills/"):
