# -*- coding: utf-8 -*-
"""Auto-generated wrapper for paper_data_check.pyc (Python 3.11 pyc).
...
_pyc_path = _os.path.join(_os.path.dirname(_os.path.abspath(__file__)), "paper_data_check.pyc")
if not _os.path.exists(_pyc_path):
    print(f"ERROR: paper_data_check.pyc not found at {_pyc_path}")
    sys.exit(1)
