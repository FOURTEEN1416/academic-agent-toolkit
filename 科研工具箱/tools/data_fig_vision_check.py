# -*- coding: utf-8 -*-
"""Auto-generated wrapper for data_fig_vision_check.pyc (Python 3.11 pyc).
...
_pyc_path = _os.path.join(_os.path.dirname(_os.path.abspath(__file__)), "data_fig_vision_check.pyc")
if not _os.path.exists(_pyc_path):
    print(f"ERROR: data_fig_vision_check.pyc not found at {_pyc_path}")
    sys.exit(1)
...
_USAGE = 'Usage: python data_fig_vision_check.py <image.png>'
