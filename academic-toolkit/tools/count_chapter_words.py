# -*- coding: utf-8 -*-
"""统计 Markdown 各章节字数（反编译重建自 count_chapter_words.pyc；行为等价验证）。
用法：python count_chapter_words.py <markdown-file>
"""
...
def format_metrics(label, metrics):
    return (f"{label}\tAPPROX_WORDS={metrics['approx_word_count']}\t"
