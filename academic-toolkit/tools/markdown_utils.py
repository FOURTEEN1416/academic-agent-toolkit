# -*- coding: utf-8 -*-
"""Auto-generated wrapper for markdown_utils.pyc (Python 3.11 pyc).
...
_pyc_path = _os.path.join(_os.path.dirname(_os.path.abspath(__file__)), "markdown_utils.pyc")
if not _os.path.exists(_pyc_path):
    print(f"ERROR: markdown_utils.pyc not found at {_pyc_path}")
    sys.exit(1)
