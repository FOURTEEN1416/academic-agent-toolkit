# -*- coding: utf-8 -*-
"""Auto-generated wrapper for fix_bare_latex_in_md.pyc (Python 3.11 pyc).
...
_pyc_path = _os.path.join(_os.path.dirname(_os.path.abspath(__file__)), "fix_bare_latex_in_md.pyc")
if not _os.path.exists(_pyc_path):
    print(f"ERROR: fix_bare_latex_in_md.pyc not found at {_pyc_path}")
    sys.exit(1)
...
_USAGE = 'Usage: python {py.stem} <args...>'
