#!/usr/bin/env python3
"""draw.io 图视觉自检 — 宿主独立窗口驱动（2026-09-23 第三次用户裁定：换驱动，不拆机制）。
...
用法:
  python tools/drawio_vision_check.py <fig.pdf|fig.png> [--review]
...
def main() -> int:
    return hvr.main_stub(
        "drawio",
        "Usage: python drawio_vision_check.py <fig.pdf|fig.png> [--review]",
    )
