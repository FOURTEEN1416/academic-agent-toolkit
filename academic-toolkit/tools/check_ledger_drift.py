...
会在 skills/_utils/.engine、academic-toolkit/.engine/audit、skills/shared-scripts/.engine
...
DRIFT_GLOBS = [
    "academic-toolkit/skills/**/.engine/audit/operations.jsonl",
    "academic-toolkit/.engine/audit/operations.jsonl",
