...
```bash
python "academic-toolkit/skills/paper-figure-palette/scripts/palette_kit.py" check     # 五组判据
python "academic-toolkit/skills/paper-figure-palette/scripts/palette_kit.py" preview   # 出色卡
```
