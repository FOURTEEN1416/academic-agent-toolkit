...
|-------------------|---------------|-------|--------------|
| Explore a topic | Starting fresh | 30 min | comp-contest-research quick |
| Explore a topic | Starting fresh | 2+ hr | comp-contest-research full |
| Think through a research idea | Have vague idea | Any | comp-contest-research socratic |
| Systematic review | Have clear PICO | 3+ hr | comp-contest-research systematic-review |
| Verify claims | Have specific claims | 30 min | comp-contest-research fact-check |
...
|-----------|-------------------|-----|
| "Write me a paper on X" | comp-contest-research first, THEN academic-paper | Writing without research produces shallow papers with unsupported claims |
...
| "I need a systematic review" | comp-contest-research systematic-review mode | NOT academic-paper lit-review structure (different methodology: PRISMA vs narrative) |
| "Just give me a quick paper" | comp-contest-research quick + academic-paper full | Quick research is fine, but paper writing still needs the full mode for quality |
...
|-----------|---------------------|-----------|
| Graduate student (first paper) | comp-contest-research socratic -> academic-paper plan -> full pipeline | Socratic mode builds research thinking; plan mode structures the paper incrementally; pipeline ensures quality gates |
...
| Quick literature scan | comp-contest-research quick or lit-review | Fast turnaround; no need for full pipeline overhead |
...
| Conference paper (short deadline) | comp-contest-research quick -> academic-paper full (conference type) | Compressed timeline; quick research + full writing with conference structure |
| Thesis chapter | comp-contest-research full -> academic-paper full | Each chapter treated as a standalone paper; full depth needed |
| Policy brief | comp-contest-research quick -> academic-paper full (policy_brief type) | Evidence-based but concise; quick research sufficient for policy scope |
...
|-------|--------|-----------|
| comp-contest-research | Literature search, synthesis, RQ refinement, fact-checking | Write papers, review papers, format documents |
...
START: What does the user want?
  ...
  |      |
  |      +--> Have specific claims to verify? --> comp-contest-research fact-check
  |      +--> Have clear PICO/systematic question? --> comp-contest-research systematic-review
  |      +--> Want guided exploration? --> comp-contest-research socratic
  |      +--> Want direct results, have time? --> comp-contest-research full
  |      +--> Want direct results, short on time? --> comp-contest-research quick
  |
  +--> "I want to write a paper"
  |      |
  |      +--> Have research/literature ready? --> academic-paper (plan or full)
  |      +--> No research done yet? --> comp-contest-research FIRST, then academic-paper
...
|-------------|---------|-----------------|
| Skipping research | Paper lacks evidence depth | Always do at least comp-contest-research quick |
...
| Using fact-check mode for literature review | Different purpose and methodology | Use comp-contest-research full or systematic-review |
