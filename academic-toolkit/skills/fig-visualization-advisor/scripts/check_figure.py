"""
fig-visualization-advisor :: check_figure.py
========================================
...
def _cli() -> int:
    p = argparse.ArgumentParser(description="fig-visualization-advisor compliance checker")
    ...
    if args.strict and any_fail:
        print("[fig-visualization-advisor] strict mode: at least one FAIL — exit 2")
        return 2
    return 0
