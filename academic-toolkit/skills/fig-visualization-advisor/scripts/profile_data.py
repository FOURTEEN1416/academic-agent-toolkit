"""
fig-visualization-advisor :: profile_data.py
========================================
Exploratory data analysis for figure planning.

本脚本是 fig-visualization-advisor"思考-绘制"工作流的第 1 步。
...
def _cli() -> int:
    p = argparse.ArgumentParser(description="fig-visualization-advisor data profiler")
