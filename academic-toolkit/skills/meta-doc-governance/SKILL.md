...
3. **定位铁律**：本项目是**完整academic-toolkit**（全学术 Agent 工具箱），不只是数模竞赛工具。
   目录名/文档标题/自我指称一律不得窄化为"数学建模/数模"。
4. **集成铁律（2026-08-29 增补）**：新技能"融入"≠ 复制进 `skills/` 目录。按设计哲学
   （`dev-docs/解析/01-总纲` 三层架构 + 三条钢律
...
| 主控文档 | `academic-toolkit/AGENTS.md`（原数学建模全流程套件） | 架构/审计/路由规则 |
