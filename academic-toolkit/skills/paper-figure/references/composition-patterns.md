...
**📏 期刊栏宽锚点（2026-09-11 收编自 academic-figure-skill @`1df9940`，Apache-2.0）**：单栏 **89mm**（3.5in）、双栏 **183mm**（7.2in）是 Nature 系/CNS 通用口径，也是"最终印刷宽度"的权威取值来源——1×4 连排在 183mm 双栏下每格仅 ~43mm<45mm，按前置条件应改 2×2。竞赛论文（单栏版心 ~150mm）同理先量后连排。
...
## 六、多面板反冗余三原则（收编自 academic-figure-skill @`1df9940`，Apache-2.0；2026-09-11 适应性改写）
