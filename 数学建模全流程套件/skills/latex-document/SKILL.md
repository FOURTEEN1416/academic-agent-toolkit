...
description: >
  ...
  【边界】竞赛论文写作请用 comp-paper-zh/comp-paper-en，竞赛编译请用 comp-compile-zh/comp-compile-en；
  本技能负责竞赛之外的通用 LaTeX 文档制作。
  【English】Universal LaTeX document skill: create, compile, and convert any document to
