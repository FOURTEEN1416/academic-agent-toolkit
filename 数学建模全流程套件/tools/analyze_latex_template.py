# -*- coding: utf-8 -*-
"""Auto-generated wrapper for analyze_latex_template.pyc (Python 3.11 pyc).
...
_pyc_path = _os.path.join(_os.path.dirname(_os.path.abspath(__file__)), "analyze_latex_template.pyc")
if not _os.path.exists(_pyc_path):
    print(f"ERROR: analyze_latex_template.pyc not found at {_pyc_path}")
    sys.exit(1)
