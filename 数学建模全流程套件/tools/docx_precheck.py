# -*- coding: utf-8 -*-
"""Auto-generated wrapper for docx_precheck.pyc (Python 3.11 pyc).
...
_pyc_path = _os.path.join(_os.path.dirname(_os.path.abspath(__file__)), "docx_precheck.pyc")
if not _os.path.exists(_pyc_path):
    print(f"ERROR: docx_precheck.pyc not found at {_pyc_path}")
    sys.exit(1)
