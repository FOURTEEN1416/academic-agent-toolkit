# -*- coding: utf-8 -*-
"""Auto-generated wrapper for generate_format_reference.pyc (Python 3.11 pyc).
...
_pyc_path = _os.path.join(_os.path.dirname(_os.path.abspath(__file__)), "generate_format_reference.pyc")
if not _os.path.exists(_pyc_path):
    print(f"ERROR: generate_format_reference.pyc not found at {_pyc_path}")
    sys.exit(1)
