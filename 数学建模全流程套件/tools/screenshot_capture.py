# -*- coding: utf-8 -*-
"""Auto-generated wrapper for screenshot_capture.pyc (Python 3.11 pyc).
...
_pyc_path = _os.path.join(_os.path.dirname(_os.path.abspath(__file__)), "screenshot_capture.pyc")
