...
> ⚠️ **本节正文为 2026-08-30 时点快照**（保留作历史）。当前唯一有效基线（**2026-09-22 P4 资产激活轮实测**）：
> 根级 `pytest -q` = **754 passed / 0 failed**（= 工具箱 **729** + 根级门禁 **25**，另 **3 skipped**、collect-only 757）——
...
> 2026-09-20 宿主无关轮 = 639（620+19）；2026-09-22 华为杯管线补齐轮 = 651（630+21）；2026-09-22 四批收编合仓轮 = 717（696+21）。
